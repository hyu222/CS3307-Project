...
public:
    ...
    std::vector<std::pair<std::string, int>> getCountTuple(int startYear, int endYear, const std::vector<std::string> &headers, const std::vector<std::string> &matchString, char filterStart, char filterEnd);
    std::vector<std::pair<std::string, double>> getTotalsTuple(int startYear, int endYear, const std::vector<std::string> &headers, const std::vector<std::string> &matchStrings, std::string accCol, char filterStart, char filterEnd);
